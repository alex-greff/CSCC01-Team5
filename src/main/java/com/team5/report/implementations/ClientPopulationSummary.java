...
public class ClientPopulationSummary extends PieChartReport {
     ...
     */
    public ClientPopulationSummary() {
        setup();
    }
    ...
    private void setup() {
        try {
            // Load configs
            String config_location = (String) ConfigurationLoader.loadConfiguration("report-locations").get("client-population-summary");
    ...
    public static void main(String[] args) {
        ...
        r.generate("testFiles/reportTests/ClientPopulationSummary.png");
    }
}